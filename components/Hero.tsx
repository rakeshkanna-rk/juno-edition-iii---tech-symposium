        ...
        <div className="flex flex-col items-center lg:items-center justify-center lg:h-full space-y-16 lg:space-y-24">
          ...
          <div className="flex flex-col space-y-6 items-center">
            ...
            <div className=" rounded-2xl text-[12px] md:text-sm font-black tracking-[0.2em]  transition-all duration-500 min-w-[240px]">
              <button className="px-10 py-5 group relative inline-block text-white/60 text-[12px] md:text-sm tracking-[0.4em] uppercase font-black transition-colors duration-300 hover:text-yellow-500">
                Rule Book
