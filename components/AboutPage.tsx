      ...
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <section className="card-glass p-8 md:p-12 lg:p-16 rounded-[40px] border-yellow-500/10 shadow-2xl">
          ...
          <div className="space-y-8 text-white/80 leading-relaxed text-sm md:text-base font-bold uppercase tracking-[0.15em] text-justify">
            <p>
              JUNO Association is the student council of School of IT. The JUNO
              association has placed a record number of achievements that
              includes both academics and cultural activities. JUNO is an
              inter-collegiate symposium event hosted by
              <span className="text-yellow-500 ml-1">
                The Departments of BCA, B.Sc. Computer Science, B.Sc. Visual
                Communication, B.Sc. Information Technology, B.Sc. Data
                Analytics, B.Sc. Computer Science With AI, MCA & M.Sc. Computer
                Science With AI
              </span>
              . JUNO has grown into one of the most vibrant student-driven
              events. Its first edition made a remarkable debut in 2024 with an
              impressive turnout of over
              <span className="text-yellow-500 mx-1">1,000+</span>
              walk-ins, setting a strong foundation for the years to come.
              Building on that momentum, the second edition surpassed
              expectations with more than
              <span className="text-yellow-500 mx-1">1,300+</span>
              participants in 2025, solidifying its reputation as a dynamic and
              highly anticipated annual gathering for students from various
              institutions.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-16">
          <h2 className="text-center font-hanora text-5xl md:text-6xl font-black text-white tracking-[0.2em] uppercase">
            Gallery
          </h2>
