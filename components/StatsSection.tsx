  ...
  return (
    <section className="py-32 px-6 relative">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="font-hanora text-5xl md:text-7xl font-black gold-text tracking-[0.3em] mb-24 uppercase">
          Events
        </h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-10">
          <button className="w-full md:w-auto px-20 py-5 rounded-md primary-btn font-hanora text-xl tracking-[0.25em] font-black uppercase transition-all duration-500 group-hover:scale-105 group-hover:drop-shadow-[0_0_30px_rgba(234,179,8,0.4)]">
            Rulebook
          </button>
          <button className="w-full md:w-auto px-20 py-5 rounded-md primary-btn font-hanora text-xl tracking-[0.25em] font-black uppercase transition-all duration-500 group-hover:scale-105 group-hover:drop-shadow-[0_0_30px_rgba(234,179,8,0.4)]">
            Register Now
